...
namespace OrdinarioProyecto.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Cantidad,Precio")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Cantidad,Precio")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
